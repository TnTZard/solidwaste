...
import com.anzhi.solidwaste.common.domain.RedisInfo;
import com.anzhi.solidwaste.common.exception.RedisConnectException;
import com.anzhi.solidwaste.common.function.JedisExecutor;
...
public class RedisServiceImpl implements RedisService {
    ...
    @Override
    public List<String> lrange(String key, long start, long stop) throws RedisConnectException {
        return this.excuteByJedis(j -> j.lrange(key, start, stop));
    }
